...
\begin{lstlisting}
wget https://github.com/mukundareddy/Signal-Processing/blob/main/cktsig/Tikz%20Circuits/2.2.tex
\end{lstlisting}
\begin{figure}[!ht]
 \centering
...
\end{align}
	...
	\begin{lstlisting}
		wget https://github.com/mukundareddy/Signal-Processing/tree/main/cktsig/codes/2.7.py
	\end{lstlisting}
...
\begin{lstlisting}
	wget https://github.com/mukundareddy/Signal-Processing/tree/main/cktsig/codes/2.8.cir
\end{lstlisting}
And is plotted using the below code.
\begin{lstlisting}
	wget https://github.com/mukundareddy/Signal-Processing/tree/main/cktsig/codes/2.8.py
\end{lstlisting}
...
\end{align} 
	...
	\solution Running the following code gives the plot.
	\begin{lstlisting}
		wget https://github.com/mukundareddy/Signal-Processing/tree/main/cktsig/codes/3.4.py
	\end{lstlisting}
	From \eqref{eq:v2-s},
\begin{align}
...
\end{figure}
	...
	\solution Results obtained can be verified by running the following code.
	\begin{lstlisting}
wget https://github.com/mukundareddy/Signal-Processing/tree/main/cktsig/codes/3.5.cir
	\end{lstlisting}
Runningn the below code plots the figure \ref{fig:ngspice2}, and verifies our result.
	\begin{lstlisting}
wget https://github.com/mukundareddy/Signal-Processing/tree/main/cktsig/codes/3.5.py
	\end{lstlisting}
...
\begin{lstlisting}
	wget https://github.com/mukundareddy/Signal-Processing/tree/main/cktsig/codes/4.2.py
\end{lstlisting}
...
%\end{align}
	...
	\begin{lstlisting}
	wget https://github.com/mukundareddy/Signal-Processing/tree/main/cktsig/codes/4.3.py
	\end{lstlisting}
	\begin{figure}[!ht]
		\centering
...
\begin{lstlisting}
wget https://github.com/mukundareddy/Signal-Processing/tree/main/cktsig/codes/4.7.py
\end{lstlisting}
