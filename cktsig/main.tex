...
\begin{lstlisting}
wget https://github.com/mohilmukundareddy/Signal-processing/blob/main/cktsig/Tikz%20Circuits/2.2.tex
\end{lstlisting}
\begin{figure}[!ht]
 \centering
...
\end{align}
	...
	\begin{lstlisting}
wget https://github.com/mohilmukundareddy/Signal-processing/blob/main/cktsig/codes/2.4.py
python3 2.4.py	
\end{lstlisting}
	\begin{figure}[!ht]
			\centering
...
\end{figure}
	\item Show that 
		...
		The following command plots the ROC of above Laplace Transform.
	\begin{lstlisting}
wget https://github.com/mohilmukundareddy/Signal-processing/blob/main/cktsig/codes/2.5.py
python3 2.5.py	
\end{lstlisting}
		\begin{figure}[!ht]
			\centering
...
\end{figure}
	...
	\begin{lstlisting}
wget https://github.com/mohilmukundareddy/Signal-processing/blob/main/cktsig/codes/2.7.py
python3 2.7.py	
\end{lstlisting}
	\begin{figure}[!ht]
			\centering
...
\end{figure}
	...
	\begin{lstlisting}
wget https://github.com/mohilmukundareddy/Signal-processing/blob/main/cktsig/codes/2.8.cir
ngspice 2.8.cir	
python3 2.8.py
\end{lstlisting}
\begin{figure}[!ht]
...
Use latex-tikz.
		\label{prob:init}\\
		\solution 
		The following command downloads tex file of circuit.
	\begin{lstlisting}
wget https://github.com/mohilmukundareddy/Signal-processing/blob/main/cktsig/Tikz Circuits/3.2.tex
\end{lstlisting}
	\begin{figure}[!ht]
 \centering
...
The following command plots the above equation.
	\begin{lstlisting}
wget https://github.com/mohilmukundareddy/Signal-processing/blob/main/cktsig/codes/3.4.py
python3 3.4.py	
\end{lstlisting}
\begin{figure}[!ht]
			\centering
...
\end{figure}
	...
	\begin{lstlisting}
wget https://github.com/mohilmukundareddy/Signal-processing/blob/main/cktsig/codes/3.5.cir
ngspice 3.5.cir	
python3 3.5.py
\end{lstlisting}
	 \begin{figure}[!ht]
...
\item Obtain Fig. \ref{prob:init} using the equivalent differential equation
	...
	\begin{lstlisting}
		https://github.com/mohilmukundareddy/Signal-processing/blob/main/cktsig/codes/4.3.py
		python 4.3.py
	\end{lstlisting}
	\begin{figure}[!ht]
		\centering
