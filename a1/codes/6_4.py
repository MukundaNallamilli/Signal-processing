...
plt.stem(n_arr, vec_y(n_arr), markerfmt='bo', label='$difference equation$')
plt.stem(n_arr, np.real(IDFT(n_arr, Y)), markerfmt='go', label='$IDFT$')
plt.stem(n_arr, np.real(y_arr), markerfmt='ro', label='$IFFT$')
