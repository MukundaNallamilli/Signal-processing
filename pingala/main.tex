...
\begin{lstlisting}
	wget https://github.com/mohilmukundareddy/EE3900/blob/main/pingala/codes/1_1.py
\end{lstlisting}
...
Run the below python code 
\begin{lstlisting}
	wget https://github.com/mohilmukundareddy/EE3900/blob/main/pingala/codes/1_2.py
\end{lstlisting}
Use the following command in the terminal to run the code
\begin{lstlisting}
	python3 1_2.py
...
\begin{figure}[h]
	\centering
	\includegraphics[scale = 0.6]{./figs/1_2.png}
	\caption{}
\end{figure}
\item 
\begin{align}
...
Run the below python code 
\begin{lstlisting}
	wget https://github.com/mohilmukundareddy/EE3900/blob/main/pingala/codes/1_3.py
\end{lstlisting}
Use the following command in the terminal to run the code
\begin{lstlisting}
	python3 1_3.py
...
\begin{figure}[h]
	\centering
	\includegraphics[scale = 0.6]{./figs/1_3.png}
	\caption{}
\end{figure}
\item 
\begin{align}
...
Run the below python code 
\begin{lstlisting}
	wget https://github.com/mohilmukundareddy/EE3900/blob/main/pingala/codes/1_4.py
\end{lstlisting}
Use the following command in the terminal to run the code
\begin{lstlisting}
	python3 1_4.py
...
Run the below python code 
\begin{lstlisting}
	wget https://github.com/mohilmukundareddy/EE3900/blob/main/pingala/codes/2_2.py
\end{lstlisting}
Use the following command in the terminal to run the code
\begin{lstlisting}
	python3 2_2.py
...
Run the below python code 
\begin{lstlisting}
	wget https://github.com/mohilmukundareddy/EE3900/blob/main/pingala/codes/2_5.py
\end{lstlisting}
Use the following command in the terminal to run the code
\begin{lstlisting}
	python3 2_5.py
...
\begin{lstlisting}
	wget https://github.com/mohilmukundareddy/EE3900/blob/main/pingala/codes/3.py
\end{lstlisting}
Use the following command in the terminal to run the code
\begin{lstlisting}
	python3 3.py
